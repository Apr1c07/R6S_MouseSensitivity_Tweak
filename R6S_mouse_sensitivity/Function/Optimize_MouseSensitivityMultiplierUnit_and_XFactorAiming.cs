...
{
    public partial class Optimize_MouseSensitivityMultiplierUnit_and_XFactorAiming : Form
    {
        ...
        public Optimize_MouseSensitivityMultiplierUnit_and_XFactorAiming()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (checkBox1.Checked == true) { optimisation_MSMU(); }

                    if (checkBox2.Checked == true) { optimisation_XFA(); }
                }
            }
